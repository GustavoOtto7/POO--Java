...
public class CarroSuv extends CarroEletrico {
    ...
    public CarroSuv(int id, String marca, String modelo, int anoFab, int capBateria, int maxAuto) {
        super(id, marca, modelo, anoFab, capBateria, maxAuto > MIN_AUTO ? maxAuto : MIN_AUTO);
